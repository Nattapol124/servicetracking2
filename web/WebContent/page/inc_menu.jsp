...
<div class="backplane">
	...
	<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-faded"
		...
		<a href="#"
			...
			src="https://www.gtt2004.com/img/GTT_WHITE.png" width=16%;></img>
		</a>
		...
		<c:if test="${SSUser.id_user_type.id eq 2}">
			...
			<ul class="nav nav-pills flex-column mb-auto">
				<li><a href="index.htm?mode=getRequest"
					...
					</svg> <use xlink:href="#speedometer2"></use> </svg> REQUEST TABLE
				</a></li>
				<li><a href="index.htm?mode=getProject"
					class="nav-link text-white"> <svg
							xmlns="http://www.w3.org/2000/svg" width="16" height="16"
							fill="currentColor" class="bi bi-calendar-plus"
							viewBox="0 0 16 16">
  					<path
								d="M8 7a.5.5 0 0 1 .5.5V9H10a.5.5 0 0 1 0 1H8.5v1.5a.5.5 0 0 1-1 0V10H6a.5.5 0 0 1 0-1h1.5V7.5A.5.5 0 0 1 8 7z" />
  					<path
								d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4H1z" />
					</svg> <use xlink:href="#speedometer2"></use> </svg>ADD REQUEST
				</a></li>
			</ul>
			<hr>
		</c:if>
