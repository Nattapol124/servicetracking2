								...
								<logic:iterate id="item" name="loginForm" property="resultList" indexId="index">
									<tr class="att">
										<td align="center" class="fw-normal mb-1 "
											...
											data-bs-target="#editPasswordModal${item.id}"><%=index + 1%></td>
										<td align="center" class="fw-normal mb-1 "
											data-bs-toggle="modal"
										...
										<td align="center">
											<button type="button" onclick="submitFormEdit('${item.id}','initChangePasswordUser')" 
												class="btn btn-primary btn-xs"><i class="fa fa-edit">รีเซ็ทรหัส</i>
											</button>

											<button type="button" onclick="submitFormRemove('${item.id}');"
												class="btn btn-danger btn-xs"> <i class="fa fa-trash-o">ลบบัญชี</i>
											</button>
										</td>
									</tr>
...
// 				newcon : "required",
			...
			submitHandler : function(form) {
				document.forms[0].mode.value = 'resetPassword1';
