...
<!-- 		Search form -->
<!-- 		Toggle button -->
		<a class="navbar-brand justify-content-start text-light" href="#">ระบบแจ้งปัญหา</a>
			...
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle d-flex align-items-center" href="#"
						...
						<img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(9).jpg" alt="" width="35" height="35">
						<span class="navbar-brand mb-0 text-light">${SSUser.username}</span> 
<!-- 						<img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(9).jpg" class="rounded-circle" height="30" alt="" loading="lazy" /> -->
					...
					<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
						<li><a class="dropdown-item"href="login.htm?mode=initProfile">โปรไฟล์</a></li>
						<li><a class="dropdown-item" href="login.htm?mode=initChange">เปลี่ยนระหัสผ่าน</a></li>
						<li><hr class="dropdown-divider"></li>
						<li><a class="dropdown-item" href="login.htm?mode=index">ออกจากระบบ</a></li>
					</ul>
				</li>
			</ul>
<!-- 			Left links -->
