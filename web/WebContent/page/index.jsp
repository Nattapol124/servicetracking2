...
#login-left {
	background-image:
		url("${pageContext.request.contextPath}/vec/ui/img/bg/bg_login_left.png");
...
.logo {
	...
	<html:form action="/login" styleId="eduForm">
		...
		<div class="container">
			<div class="logo">
				<img src="https://www.gtt2004.com/img/GTT_WHITE.png" alt=""
					width="200" height="220"> Service Tracking
							...
							<div class="login-box">
								...
								<div class="form-group">
									<div class="col-sm-10" style="margin: 0 auto; float: none;">
										<html:text property="un" maxlength="75"
											styleClass="form-control" styleId="un"
											onkeypress="submitEnter();" placeHolder="ชื่อผู้ใช้งาน" />
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-10" style="margin: 0 auto; float: none;">
										<html:password property="pw" maxlength="75"
											styleClass="form-control" styleId="pw"
											onkeypress="submitEnter();" placeHolder="รหัสผ่าน" />
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-10" style="margin: 0 auto; float: none;">
										<button type="button" class="btn btn-blue btn-sm"
											style="width: 100%;" onclick="submitFormLogin();">เข้าสู่ระบบ</button>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<logic:equal name="msgErrorCheck" value="true">
										<div class="col-sm-10 fred"
											style="margin: 0 auto; float: none;">
											<div class="alert alert-danger"
												style="padding: 5px; font-size: 12px;">${msgError}</div>
										</div>
									</logic:equal>
